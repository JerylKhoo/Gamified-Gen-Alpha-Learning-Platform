...
// Active character icon — swap this out when the user picks a different character
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_20%_20%,#110d2e_0%,#050508_70%)] flex flex-row items-stretch">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-7 overflow-auto min-h-0 max-sm:p-4">
        <div className="h-[88vh] grid grid-cols-[auto_auto] grid-rows-[auto_1fr] gap-[1.1rem] w-fit min-w-[70%] max-lg:min-w-[90%] max-sm:h-auto max-sm:w-full max-sm:flex max-sm:flex-col">
          ...
          <div className={`${cardCls} col-start-1 row-start-1 flex items-center gap-7`}>
            {/* Character avatar — no box, edit button below */}
            <div className="flex-shrink-0 flex flex-col items-center gap-2">
              ...
              {/* Edit button — wire up onClick when character picker is ready */}
