...
/**
 * Concrete implementation of AdaptiveLearningService using IRT (1PL Rasch) and SM-2 Spaced Repetition.
 *
...
public class AdaptiveLearningServiceImpl implements AdaptiveLearningService {
    ...
    public AdaptiveLearningServiceImpl(QuizRepository quizRepository,
